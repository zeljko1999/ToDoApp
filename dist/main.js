...
function drawTask(toDo, proID) { 
    ...
    newDate.textContent = ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(toDo.dateDue), 'MMM do'))
    ...
    newDeleteBtn.addEventListener('click', function() {
        ...
        for(let i=0; i<_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects.length; i++)
            ...
            {
                for(let l=0; l<_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks.length; l++)
                {
                    if(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks[l] === toDo)
                    {
                    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks.splice(l,1)
                    }
                }
            taskManager.drawAllTasks(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks, _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].id)
            console.log(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks)
            }
        })
...
const projectsManager = (() => {
  ...
  const addEListener = (project) => {
    project.addEventListener('click', function(){
      ...
      _DOM__WEBPACK_IMPORTED_MODULE_0__.taskManager.drawAllTasks(projectsManager.projects[i].tasks, projectsManager.projects[i].id)
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html,body{\n  height: 100%;\n  margin:0;\n  padding:0;\n}\n*{\n  font-family: Arial, Helvetica, sans-serif;\n}\nbody{\n  display:flex;\n  background: linear-gradient(to right bottom, rgba(45, 123, 113, 0.8), rgba(33, 117, 115, 0.9)), url(https://bscottnz.github.io/todo/img/wood-bg.jpg);\n}\n#content{\n    flex:1;\n    padding: 5% 10%;\n    height: auto;\n    display:grid;\n    grid-template-rows: 2fr 14fr 1fr;\n    grid-template-columns: 1.5fr 7fr;\n}\n\n.header{\n    padding: 5px 20px;\n    grid-area: 1 / 1 / 2 / 3;\n    background-color: rgb(88, 23, 23);\n    font-size: 50px;\n    color:white;\n    display:flex;\n    align-items:center;\n}\n\n.sidebar{\n    grid-area: 2 / 1 / 3 / 2;\n    display:flex;\n    flex-direction:column;\n    background-color: rgb(28, 29, 30);\n    border-right: 1px black solid;\n    padding: 20px;\n    color:white;\n}\n.sidebar>button, .projects>button, .notes>button{\n  background-color: rgb(121, 38, 38);\n  color:white;\n  font-size: 20px;\n}\n.sidebar>button, .projects>button, .notes>button:hover{\n  cursor:pointer;\n}\n.projects, .notes{\n  font-size: 25px;\n}\n.addNewBtn{\n  margin-top: auto;\n  align-self: flex-start;\n  width: 60px;\n  height: 60px;\n  border-radius: 50%;\n  background-color: brown;\n  color: white;\n  font-size: 40px;\n}\n.main{\n    grid-area: 2 / 2 / 3 / 3;\n    padding-top: 30px;\n    padding-bottom: 30px;\n    background-color: rgb(208, 205, 201);\n    border-color: rgb(28, 29, 30)\n}\n.main-content{\n    background-color:rgb(28, 29, 30);;\n    height: 100%;\n    padding-left: 40px;\n    padding-right: 40px;\n    display:flex;\n    flex-direction: column;\n    gap: 10px;\n}\n.footer{\n    grid-area: 3 / 1 / 4 / 3;\n}\n.projects{\n    display:flex;\n    flex-direction:column;\n}\n.query-form{\n    display:none;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n    z-index: 9999;\n}\n.form-header{\n    grid-area: 1/1/2/3;\n    display:flex;\n    justify-content: space-between;\n    align-items: center;\n}\n.form-sidebar{\n    grid-area: 2/1/4/2;\n    display:flex;\n    flex-direction:column;\n    gap:1px;\n}\n.form-main{\n    grid-area: 2/2/3/3;\n    display:flex;\n    flex-direction: column;\n}\n.form-footer{\n    grid-area:3/2/4/3;\n    display:grid;\n    grid-template-rows: 1fr 1fr;\n}\n.radio-buttons{\n  display:flex;\n  align-items: center;\n  width:100%;\n  gap: 5px;\n}\n.formContent {\n    width: 600px;\n    height: 400px;\n    display:grid;\n    grid-template-rows: 40px 250px 100px;\n    grid-template-columns: 120px 1fr;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    background-color: white;\n    padding: 20px;\n    border-radius: 5px;\n  }\n  .form-sidebar > button{\n    border: none;\n\tpadding: 8px 15px 8px 15px;\n\tbackground: rgb(88, 23, 23);\n\tcolor: #fff;\n\tbox-shadow: 1px 1px 4px #DADADA;\n\t-moz-box-shadow: 1px 1px 4px #DADADA;\n\t-webkit-box-shadow: 1px 1px 4px #DADADA;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n  width: 100px;\n  }\n  #close-formBtn{\n  border: none;\n\tpadding: 8px 15px 8px 15px;\n\tbackground: rgb(88, 23, 23);\n\tcolor: #fff;\n\tbox-shadow: 1px 1px 4px #DADADA;\n\tborder-radius:10px;\n  }\n  .submit-form{\n    justify-self:center;\n  }\n  #close-formBtn:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  .form-sidebar > button:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  input[type=submit]{\n  border: none;\n\tbackground: rgb(88, 23, 23);\n\tbox-shadow: 1px 1px 4px #DADADA;\n  color:white;\n\t-moz-box-shadow: 1px 1px 4px #DADADA;\n\t-webkit-box-shadow: 1px 1px 4px #DADADA;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n  width: 100px;\n  }\n  input[type=submit]:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  input[type=button]{\n    box-sizing: border-box;\n\t-webkit-box-sizing: border-box;\n\t-moz-box-sizing: border-box;\n\tborder: 1px solid #C2C2C2;\n\tbox-shadow: 1px 1px 4px #EBEBEB;\n\t-moz-box-shadow: 1px 1px 4px #EBEBEB;\n\t-webkit-box-shadow: 1px 1px 4px #EBEBEB;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n\tpadding: 7px;\n\toutline: none;\n  }\n  input[type=checkbox]{\n    box-sizing: border-box;\n\t-webkit-box-sizing: border-box;\n\t-moz-box-sizing: border-box;\n\tborder: 1px solid #C2C2C2;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n\tpadding: 7px;\n\toutline: none;\n  }\n  input:focus{\n    border: 1px solid rgb(129, 39, 39);\n  }\n\n  .priority-label-low, .priority-label-medium, .priority-label-high{\n    border: none;\n    padding: 5px 0;\n    box-shadow: 1px 1px 4px #DADADA;\n    color: white;\n    -moz-box-shadow: 1px 1px 4px #DADADA;\n    -webkit-box-shadow: 1px 1px 4px #DADADA;\n    border-radius: 3px;\n    -webkit-border-radius: 3px;\n    -moz-border-radius: 3px;\n    width: 100px;\n    text-align:center;\n  }\n  .priority-label-low-selected, .priority-label-medium-selected, .priority-label-high-selected{\n    border: none;\n    padding: 5px 0;\n    box-shadow: 1px 1px 4px #DADADA;\n    color: white;\n    -moz-box-shadow: 1px 1px 4px #DADADA;\n    -webkit-box-shadow: 1px 1px 4px #DADADA;\n    border-radius: 3px;\n    -webkit-border-radius: 3px;\n    -moz-border-radius: 3px;\n    width: 100px;\n    text-align:center;\n  }\n  .priority-label-low{\n    background-color:rgb(14, 94, 14);\n  }\n  .priority-label-low-selected{\n    background-color:rgb(111, 185, 111);\n  }\n  .priority-label-low:hover{\n    background-color:rgb(107, 184, 107);\n    cursor:pointer;\n  }\n  .priority-label-medium{\n    background-color:rgb(216, 150, 26)\n  }\n  .priority-label-medium-selected{\n    background-color:rgb(192, 163, 33)\n  }\n  .priority-label-medium:hover{\n    background-color:rgb(192, 163, 33);\n    cursor:pointer;\n  }\n  .priority-label-high{\n    background-color:rgb(190, 28, 28);\n  }\n  .priority-label-high-selected{\n    background-color:rgb(197, 74, 74);\n  }\n  .priority-label-high:hover{\n    background-color:rgb(190, 73, 73);\n    cursor:pointer;\n  }\n  .prio-high{\n    border-left: 3px rgb(190, 28, 28) solid;\n  }\n  .prio-medium{\n    border-left: 3px rgb(216, 150, 26) solid;\n  }\n  .prio-low{\n    border-left: 3px rgb(14, 94, 14) solid;\n  }\n  input[type=radio]\n  {\n    position: relative;\n    left: 2.2rem;\n    height: 1px;\n    width: 1px;\n    padding: 0;\n    margin: 0;\n    opacity: 0;\n    box-sizing: inherit;\n  }\n  .main-content-line{\n    display:flex;\n    justify-content: space-between;\n    align-items:center;\n    padding: 6px;\n    color: white;\n    background-color: rgb(32, 34, 36);\n  }\n  .main-content-line:hover{\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n    transform: scale(1.004);\n  }\n  .fade{\n    text-decoration: line-through;\n    color:rgba(255,255,255,0.3);\n    -webkit-transition: all .3s;\n    transition: all .3s;\n  }\n  .fadeBtn{\n    background-color: rgba(255,255,255,.3)\n  }\n  .details-button{\n    position: relative;\n    margin-right: 1rem;\n    padding: 0.5rem 1rem;\n    border: 1.5px solid #38ceba;\n    border-radius: 3px;\n    font-size: 12px;\n    color: #3ba395;\n    text-transform: uppercase;\n    font-weight: 700;\n    cursor: pointer;\n    -webkit-transition: all .3s;\n    transition: all .3s;\n    background-color:inherit;\n  }\n  .details-button:hover{\n    border-color: rgba(47, 131, 120, 0.5);\n    color: rgba(98, 190, 178, 0.5);\n    background-color:rgb(39, 141, 127);\n    cursor:pointer;\n  }\n  .fadeBtn{\n    opacity: 0.3;\n    background-color: inherit;\n  }\n .contentBtn{\n  all:unset;\n  padding: 5px;\n  background-color: rgb(32, 34, 36);\n }\n .fa-trash-can, .fa-pen-to-square{\n  transition: all .3s;\n  color:crimson\n }\n .fa-trash-can:hover, .fa-pen-to-square:hover{\n  cursor:pointer;\n  color: #3ba395;\n }\n  .main-content-line-div{\n    display:flex;\n    align-items:center;\n    gap: 12px;\n  }\n  .main-content-line-div > button > .icon {\n    width: 15px;\n    height: 15px;\n  }\n  .line-date{\n    min-width: 75px;\n  }\n  .details-display{\n    width: 300px;\n    height: 200px;\n    display:grid;\n    grid-template-rows: 100px 200px;\n    grid-template-columns: 1fr;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    background-color: #fff;\n    padding: 30px;\n    border-radius: 5px;\n  }\n  .details-container{\n    display:none;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n    z-index: 9999;\n  }\n  .details-header{\n    grid-area: 1/1/2/1;\n    display:flex;\n    justify-content: space-between;\n  }\n  .details-body{\n    grid-area: 2/1/2/1;\n    display:flex;\n    flex-direction: column;\n  }\n  .details-exitBtn{\n    width:40px;\n    height: 40px;\n  }\n  .details-title{\n    font-size: 60px;\n  }\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,QAAQ;EACR,SAAS;AACX;AACA;EACE,yCAAyC;AAC3C;AACA;EACE,YAAY;EACZ,oJAAoJ;AACtJ;AACA;IACI,MAAM;IACN,eAAe;IACf,YAAY;IACZ,YAAY;IACZ,gCAAgC;IAChC,gCAAgC;AACpC;;AAEA;IACI,iBAAiB;IACjB,wBAAwB;IACxB,iCAAiC;IACjC,eAAe;IACf,WAAW;IACX,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,wBAAwB;IACxB,YAAY;IACZ,qBAAqB;IACrB,iCAAiC;IACjC,6BAA6B;IAC7B,aAAa;IACb,WAAW;AACf;AACA;EACE,kCAAkC;EAClC,WAAW;EACX,eAAe;AACjB;AACA;EACE,cAAc;AAChB;AACA;EACE,eAAe;AACjB;AACA;EACE,gBAAgB;EAChB,sBAAsB;EACtB,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,uBAAuB;EACvB,YAAY;EACZ,eAAe;AACjB;AACA;IACI,wBAAwB;IACxB,iBAAiB;IACjB,oBAAoB;IACpB,oCAAoC;IACpC;AACJ;AACA;IACI,gCAAgC;IAChC,YAAY;IACZ,kBAAkB;IAClB,mBAAmB;IACnB,YAAY;IACZ,sBAAsB;IACtB,SAAS;AACb;AACA;IACI,wBAAwB;AAC5B;AACA;IACI,YAAY;IACZ,qBAAqB;AACzB;AACA;IACI,YAAY;IACZ,eAAe;IACf,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,oCAAoC,EAAE,gCAAgC;IACtE,aAAa;AACjB;AACA;IACI,kBAAkB;IAClB,YAAY;IACZ,8BAA8B;IAC9B,mBAAmB;AACvB;AACA;IACI,kBAAkB;IAClB,YAAY;IACZ,qBAAqB;IACrB,OAAO;AACX;AACA;IACI,kBAAkB;IAClB,YAAY;IACZ,sBAAsB;AAC1B;AACA;IACI,iBAAiB;IACjB,YAAY;IACZ,2BAA2B;AAC/B;AACA;EACE,YAAY;EACZ,mBAAmB;EACnB,UAAU;EACV,QAAQ;AACV;AACA;IACI,YAAY;IACZ,aAAa;IACb,YAAY;IACZ,oCAAoC;IACpC,gCAAgC;IAChC,kBAAkB;IAClB,QAAQ;IACR,SAAS;IACT,gCAAgC;IAChC,uBAAuB;IACvB,aAAa;IACb,kBAAkB;EACpB;EACA;IACE,YAAY;CACf,0BAA0B;CAC1B,2BAA2B;CAC3B,WAAW;CACX,+BAA+B;CAC/B,oCAAoC;CACpC,uCAAuC;CACvC,kBAAkB;CAClB,0BAA0B;CAC1B,uBAAuB;EACtB,YAAY;EACZ;EACA;EACA,YAAY;CACb,0BAA0B;CAC1B,2BAA2B;CAC3B,WAAW;CACX,+BAA+B;CAC/B,kBAAkB;EACjB;EACA;IACE,mBAAmB;EACrB;EACA;IACE,cAAc;IACd,4BAA4B;GAC7B,WAAW;EACZ;EACA;IACE,cAAc;IACd,4BAA4B;GAC7B,WAAW;EACZ;EACA;EACA,YAAY;CACb,2BAA2B;CAC3B,+BAA+B;EAC9B,WAAW;CACZ,oCAAoC;CACpC,uCAAuC;CACvC,kBAAkB;CAClB,0BAA0B;CAC1B,uBAAuB;EACtB,YAAY;EACZ;EACA;IACE,cAAc;IACd,4BAA4B;GAC7B,WAAW;EACZ;EACA;IACE,sBAAsB;CACzB,8BAA8B;CAC9B,2BAA2B;CAC3B,yBAAyB;CACzB,+BAA+B;CAC/B,oCAAoC;CACpC,uCAAuC;CACvC,kBAAkB;CAClB,0BAA0B;CAC1B,uBAAuB;CACvB,YAAY;CACZ,aAAa;EACZ;EACA;IACE,sBAAsB;CACzB,8BAA8B;CAC9B,2BAA2B;CAC3B,yBAAyB;CACzB,kBAAkB;CAClB,0BAA0B;CAC1B,uBAAuB;CACvB,YAAY;CACZ,aAAa;EACZ;EACA;IACE,kCAAkC;EACpC;;EAEA;IACE,YAAY;IACZ,cAAc;IACd,+BAA+B;IAC/B,YAAY;IACZ,oCAAoC;IACpC,uCAAuC;IACvC,kBAAkB;IAClB,0BAA0B;IAC1B,uBAAuB;IACvB,YAAY;IACZ,iBAAiB;EACnB;EACA;IACE,YAAY;IACZ,cAAc;IACd,+BAA+B;IAC/B,YAAY;IACZ,oCAAoC;IACpC,uCAAuC;IACvC,kBAAkB;IAClB,0BAA0B;IAC1B,uBAAuB;IACvB,YAAY;IACZ,iBAAiB;EACnB;EACA;IACE,gCAAgC;EAClC;EACA;IACE,mCAAmC;EACrC;EACA;IACE,mCAAmC;IACnC,cAAc;EAChB;EACA;IACE;EACF;EACA;IACE;EACF;EACA;IACE,kCAAkC;IAClC,cAAc;EAChB;EACA;IACE,iCAAiC;EACnC;EACA;IACE,iCAAiC;EACnC;EACA;IACE,iCAAiC;IACjC,cAAc;EAChB;EACA;IACE,uCAAuC;EACzC;EACA;IACE,wCAAwC;EAC1C;EACA;IACE,sCAAsC;EACxC;EACA;;IAEE,kBAAkB;IAClB,YAAY;IACZ,WAAW;IACX,UAAU;IACV,UAAU;IACV,SAAS;IACT,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,YAAY;IACZ,8BAA8B;IAC9B,kBAAkB;IAClB,YAAY;IACZ,YAAY;IACZ,iCAAiC;EACnC;EACA;IACE,2CAA2C;IAC3C,uBAAuB;EACzB;EACA;IACE,6BAA6B;IAC7B,2BAA2B;IAC3B,2BAA2B;IAC3B,mBAAmB;EACrB;EACA;IACE;EACF;EACA;IACE,kBAAkB;IAClB,kBAAkB;IAClB,oBAAoB;IACpB,2BAA2B;IAC3B,kBAAkB;IAClB,eAAe;IACf,cAAc;IACd,yBAAyB;IACzB,gBAAgB;IAChB,eAAe;IACf,2BAA2B;IAC3B,mBAAmB;IACnB,wBAAwB;EAC1B;EACA;IACE,qCAAqC;IACrC,8BAA8B;IAC9B,kCAAkC;IAClC,cAAc;EAChB;EACA;IACE,YAAY;IACZ,yBAAyB;EAC3B;CACD;EACC,SAAS;EACT,YAAY;EACZ,iCAAiC;CAClC;CACA;EACC,mBAAmB;EACnB;CACD;CACA;EACC,cAAc;EACd,cAAc;CACf;EACC;IACE,YAAY;IACZ,kBAAkB;IAClB,SAAS;EACX;EACA;IACE,WAAW;IACX,YAAY;EACd;EACA;IACE,eAAe;EACjB;EACA;IACE,YAAY;IACZ,aAAa;IACb,YAAY;IACZ,+BAA+B;IAC/B,0BAA0B;IAC1B,kBAAkB;IAClB,QAAQ;IACR,SAAS;IACT,gCAAgC;IAChC,sBAAsB;IACtB,aAAa;IACb,kBAAkB;EACpB;EACA;IACE,YAAY;IACZ,eAAe;IACf,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,oCAAoC,EAAE,gCAAgC;IACtE,aAAa;EACf;EACA;IACE,kBAAkB;IAClB,YAAY;IACZ,8BAA8B;EAChC;EACA;IACE,kBAAkB;IAClB,YAAY;IACZ,sBAAsB;EACxB;EACA;IACE,UAAU;IACV,YAAY;EACd;EACA;IACE,eAAe;EACjB","sourcesContent":["html,body{\n  height: 100%;\n  margin:0;\n  padding:0;\n}\n*{\n  font-family: Arial, Helvetica, sans-serif;\n}\nbody{\n  display:flex;\n  background: linear-gradient(to right bottom, rgba(45, 123, 113, 0.8), rgba(33, 117, 115, 0.9)), url(https://bscottnz.github.io/todo/img/wood-bg.jpg);\n}\n#content{\n    flex:1;\n    padding: 5% 10%;\n    height: auto;\n    display:grid;\n    grid-template-rows: 2fr 14fr 1fr;\n    grid-template-columns: 1.5fr 7fr;\n}\n\n.header{\n    padding: 5px 20px;\n    grid-area: 1 / 1 / 2 / 3;\n    background-color: rgb(88, 23, 23);\n    font-size: 50px;\n    color:white;\n    display:flex;\n    align-items:center;\n}\n\n.sidebar{\n    grid-area: 2 / 1 / 3 / 2;\n    display:flex;\n    flex-direction:column;\n    background-color: rgb(28, 29, 30);\n    border-right: 1px black solid;\n    padding: 20px;\n    color:white;\n}\n.sidebar>button, .projects>button, .notes>button{\n  background-color: rgb(121, 38, 38);\n  color:white;\n  font-size: 20px;\n}\n.sidebar>button, .projects>button, .notes>button:hover{\n  cursor:pointer;\n}\n.projects, .notes{\n  font-size: 25px;\n}\n.addNewBtn{\n  margin-top: auto;\n  align-self: flex-start;\n  width: 60px;\n  height: 60px;\n  border-radius: 50%;\n  background-color: brown;\n  color: white;\n  font-size: 40px;\n}\n.main{\n    grid-area: 2 / 2 / 3 / 3;\n    padding-top: 30px;\n    padding-bottom: 30px;\n    background-color: rgb(208, 205, 201);\n    border-color: rgb(28, 29, 30)\n}\n.main-content{\n    background-color:rgb(28, 29, 30);;\n    height: 100%;\n    padding-left: 40px;\n    padding-right: 40px;\n    display:flex;\n    flex-direction: column;\n    gap: 10px;\n}\n.footer{\n    grid-area: 3 / 1 / 4 / 3;\n}\n.projects{\n    display:flex;\n    flex-direction:column;\n}\n.query-form{\n    display:none;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n    z-index: 9999;\n}\n.form-header{\n    grid-area: 1/1/2/3;\n    display:flex;\n    justify-content: space-between;\n    align-items: center;\n}\n.form-sidebar{\n    grid-area: 2/1/4/2;\n    display:flex;\n    flex-direction:column;\n    gap:1px;\n}\n.form-main{\n    grid-area: 2/2/3/3;\n    display:flex;\n    flex-direction: column;\n}\n.form-footer{\n    grid-area:3/2/4/3;\n    display:grid;\n    grid-template-rows: 1fr 1fr;\n}\n.radio-buttons{\n  display:flex;\n  align-items: center;\n  width:100%;\n  gap: 5px;\n}\n.formContent {\n    width: 600px;\n    height: 400px;\n    display:grid;\n    grid-template-rows: 40px 250px 100px;\n    grid-template-columns: 120px 1fr;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    background-color: white;\n    padding: 20px;\n    border-radius: 5px;\n  }\n  .form-sidebar > button{\n    border: none;\n\tpadding: 8px 15px 8px 15px;\n\tbackground: rgb(88, 23, 23);\n\tcolor: #fff;\n\tbox-shadow: 1px 1px 4px #DADADA;\n\t-moz-box-shadow: 1px 1px 4px #DADADA;\n\t-webkit-box-shadow: 1px 1px 4px #DADADA;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n  width: 100px;\n  }\n  #close-formBtn{\n  border: none;\n\tpadding: 8px 15px 8px 15px;\n\tbackground: rgb(88, 23, 23);\n\tcolor: #fff;\n\tbox-shadow: 1px 1px 4px #DADADA;\n\tborder-radius:10px;\n  }\n  .submit-form{\n    justify-self:center;\n  }\n  #close-formBtn:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  .form-sidebar > button:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  input[type=submit]{\n  border: none;\n\tbackground: rgb(88, 23, 23);\n\tbox-shadow: 1px 1px 4px #DADADA;\n  color:white;\n\t-moz-box-shadow: 1px 1px 4px #DADADA;\n\t-webkit-box-shadow: 1px 1px 4px #DADADA;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n  width: 100px;\n  }\n  input[type=submit]:hover{\n    cursor:pointer;\n    background: rgb(129, 39, 39);\n\t  color: #fff;\n  }\n  input[type=button]{\n    box-sizing: border-box;\n\t-webkit-box-sizing: border-box;\n\t-moz-box-sizing: border-box;\n\tborder: 1px solid #C2C2C2;\n\tbox-shadow: 1px 1px 4px #EBEBEB;\n\t-moz-box-shadow: 1px 1px 4px #EBEBEB;\n\t-webkit-box-shadow: 1px 1px 4px #EBEBEB;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n\tpadding: 7px;\n\toutline: none;\n  }\n  input[type=checkbox]{\n    box-sizing: border-box;\n\t-webkit-box-sizing: border-box;\n\t-moz-box-sizing: border-box;\n\tborder: 1px solid #C2C2C2;\n\tborder-radius: 3px;\n\t-webkit-border-radius: 3px;\n\t-moz-border-radius: 3px;\n\tpadding: 7px;\n\toutline: none;\n  }\n  input:focus{\n    border: 1px solid rgb(129, 39, 39);\n  }\n\n  .priority-label-low, .priority-label-medium, .priority-label-high{\n    border: none;\n    padding: 5px 0;\n    box-shadow: 1px 1px 4px #DADADA;\n    color: white;\n    -moz-box-shadow: 1px 1px 4px #DADADA;\n    -webkit-box-shadow: 1px 1px 4px #DADADA;\n    border-radius: 3px;\n    -webkit-border-radius: 3px;\n    -moz-border-radius: 3px;\n    width: 100px;\n    text-align:center;\n  }\n  .priority-label-low-selected, .priority-label-medium-selected, .priority-label-high-selected{\n    border: none;\n    padding: 5px 0;\n    box-shadow: 1px 1px 4px #DADADA;\n    color: white;\n    -moz-box-shadow: 1px 1px 4px #DADADA;\n    -webkit-box-shadow: 1px 1px 4px #DADADA;\n    border-radius: 3px;\n    -webkit-border-radius: 3px;\n    -moz-border-radius: 3px;\n    width: 100px;\n    text-align:center;\n  }\n  .priority-label-low{\n    background-color:rgb(14, 94, 14);\n  }\n  .priority-label-low-selected{\n    background-color:rgb(111, 185, 111);\n  }\n  .priority-label-low:hover{\n    background-color:rgb(107, 184, 107);\n    cursor:pointer;\n  }\n  .priority-label-medium{\n    background-color:rgb(216, 150, 26)\n  }\n  .priority-label-medium-selected{\n    background-color:rgb(192, 163, 33)\n  }\n  .priority-label-medium:hover{\n    background-color:rgb(192, 163, 33);\n    cursor:pointer;\n  }\n  .priority-label-high{\n    background-color:rgb(190, 28, 28);\n  }\n  .priority-label-high-selected{\n    background-color:rgb(197, 74, 74);\n  }\n  .priority-label-high:hover{\n    background-color:rgb(190, 73, 73);\n    cursor:pointer;\n  }\n  .prio-high{\n    border-left: 3px rgb(190, 28, 28) solid;\n  }\n  .prio-medium{\n    border-left: 3px rgb(216, 150, 26) solid;\n  }\n  .prio-low{\n    border-left: 3px rgb(14, 94, 14) solid;\n  }\n  input[type=radio]\n  {\n    position: relative;\n    left: 2.2rem;\n    height: 1px;\n    width: 1px;\n    padding: 0;\n    margin: 0;\n    opacity: 0;\n    box-sizing: inherit;\n  }\n  .main-content-line{\n    display:flex;\n    justify-content: space-between;\n    align-items:center;\n    padding: 6px;\n    color: white;\n    background-color: rgb(32, 34, 36);\n  }\n  .main-content-line:hover{\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n    transform: scale(1.004);\n  }\n  .fade{\n    text-decoration: line-through;\n    color:rgba(255,255,255,0.3);\n    -webkit-transition: all .3s;\n    transition: all .3s;\n  }\n  .fadeBtn{\n    background-color: rgba(255,255,255,.3)\n  }\n  .details-button{\n    position: relative;\n    margin-right: 1rem;\n    padding: 0.5rem 1rem;\n    border: 1.5px solid #38ceba;\n    border-radius: 3px;\n    font-size: 12px;\n    color: #3ba395;\n    text-transform: uppercase;\n    font-weight: 700;\n    cursor: pointer;\n    -webkit-transition: all .3s;\n    transition: all .3s;\n    background-color:inherit;\n  }\n  .details-button:hover{\n    border-color: rgba(47, 131, 120, 0.5);\n    color: rgba(98, 190, 178, 0.5);\n    background-color:rgb(39, 141, 127);\n    cursor:pointer;\n  }\n  .fadeBtn{\n    opacity: 0.3;\n    background-color: inherit;\n  }\n .contentBtn{\n  all:unset;\n  padding: 5px;\n  background-color: rgb(32, 34, 36);\n }\n .fa-trash-can, .fa-pen-to-square{\n  transition: all .3s;\n  color:crimson\n }\n .fa-trash-can:hover, .fa-pen-to-square:hover{\n  cursor:pointer;\n  color: #3ba395;\n }\n  .main-content-line-div{\n    display:flex;\n    align-items:center;\n    gap: 12px;\n  }\n  .main-content-line-div > button > .icon {\n    width: 15px;\n    height: 15px;\n  }\n  .line-date{\n    min-width: 75px;\n  }\n  .details-display{\n    width: 300px;\n    height: 200px;\n    display:grid;\n    grid-template-rows: 100px 200px;\n    grid-template-columns: 1fr;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    background-color: #fff;\n    padding: 30px;\n    border-radius: 5px;\n  }\n  .details-container{\n    display:none;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n    z-index: 9999;\n  }\n  .details-header{\n    grid-area: 1/1/2/1;\n    display:flex;\n    justify-content: space-between;\n  }\n  .details-body{\n    grid-area: 2/1/2/1;\n    display:flex;\n    flex-direction: column;\n  }\n  .details-exitBtn{\n    width:40px;\n    height: 40px;\n  }\n  .details-title{\n    font-size: 60px;\n  }\n"],"sourceRoot":""}]);
// Exports
...
let todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd')
Study.tasks[0] = (0,_factory__WEBPACK_IMPORTED_MODULE_1__["default"])('red','asd',todayDate,'low')
...
homeTasksBtn.addEventListener('click', function(){
    _DOM__WEBPACK_IMPORTED_MODULE_2__.taskManager.drawAllTasks(home.tasks, home.id)
...
studyTasksBtn.addEventListener('click', function(){
    ...
    _DOM__WEBPACK_IMPORTED_MODULE_2__.taskManager.drawAllTasks(Study.tasks, Study.id)
    for(let i=0; i<_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects.length; i++)
       if(_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].isActive === 1)
       _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].isActive = 0
    Study.isActive = 1
...
todayTasksBtn.addEventListener('click', function() {
    _DOM__WEBPACK_IMPORTED_MODULE_2__.taskManager.clearMain()
    for(let i =0; i < _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects.length; i++)
    {
            if(_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].id !== 'today' &&
            _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].id !== 'thisWeek')
            {
                for(let c = 0 ; c<_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks.length; c++)
                    if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todayDate), (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks[c].dateDue)) === 0){
                        (0,_DOM__WEBPACK_IMPORTED_MODULE_2__.drawTask)(_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks[c], _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].id)
                    }
            }
        }
})
