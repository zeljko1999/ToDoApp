...
function drawTask(toDo, proID) { 
    ...
    newDeleteBtn.addEventListener('click', function() {
        ...
        for(let i=0; i<_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects.length; i++)
            ...
            let name = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].id
            localStorage.setItem(name, JSON.stringify(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i]))
            }
        })
...
function drawTodo() {
    ...
    todoLabelLow.addEventListener('click', function() {
        ...
        let name = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].id
        console.log(name)
        console.log(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i])
        localStorage.setItem(name, JSON.stringify(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i]))
        }
})
}
