...
const taskManager = (() => {
  const makeNewTask = () => {
    ...
    const newTask = (0,_factory__WEBPACK_IMPORTED_MODULE_0__["default"])(
      newTaskName.value,
  ...
  const drawAllTasks = (project, projectID) => {
    ...
    for (let i = 0; i < project.length; i++) drawTask(project[i], projectID);
  };
  const clearMain = () => {
    mainContent.replaceChildren();
  };
    ...
    for (let i = 0; i < _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects.length; i++)
      if (_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].isActive === 1) {
        ...
        taskManager.drawAllTasks(
          _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].tasks,
          _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].id
        );
        ...
        let asd = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects;
      ...
      for (let i = 0; i < _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects.length; i++)
        if (_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].isActive === 1) {
          ...
          localStorage.setItem(
            name,
            JSON.stringify(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i])
          );
          let asd = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects;
          localStorage.setItem("projects", JSON.stringify(asd));
        }
...
function loadProjects() {
  ...
  if (pro === null) {
    const home = (0,_factory__WEBPACK_IMPORTED_MODULE_0__.projectObject)("home");
    home.isActive = 1;
    const today = (0,_factory__WEBPACK_IMPORTED_MODULE_0__.projectObject)("today");
    const thisWeek = (0,_factory__WEBPACK_IMPORTED_MODULE_0__.projectObject)("thisWeek");
    const Study = (0,_factory__WEBPACK_IMPORTED_MODULE_0__.projectObject)("Study");
    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.addProject(home);
    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.addProject(today);
    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.addProject(thisWeek);
    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.addProject(Study);
    console.log(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager);
  } else _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects = pro;

  console.log(_factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects);
  const projects = document.querySelector(".projects");
  for (let i = 4; i < _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects.length; i++) {
    const newProject = document.createElement("button");
    const projectTitle = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects[i].id;
    newProject.textContent = projectTitle;
    newProject.setAttribute("id", projectTitle);
    projects.appendChild(newProject);
    _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.addEListener(newProject);
    let asd = _factory__WEBPACK_IMPORTED_MODULE_0__.projectsManager.projects;
    localStorage.setItem("projects", JSON.stringify(asd));
  }
}
...
const projectsManager = (() => {
  ...
  const addEListener = (project) => {
    project.addEventListener('click', function () {
      for (i = 0; i < projectsManager.projects.length; i++) { projectsManager.projects[i].isActive = 0 }
      for (i = 0; i < projectsManager.projects.length; i++) {
        if (projectsManager.projects[i].id === project.id) { break }
      }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html,\nbody {\n  height: 100%;\n  margin: 0;\n  padding: 0;\n}\n* {\n  font-family: Arial, Helvetica, sans-serif;\n}\nbody {\n  display: flex;\n  background: linear-gradient(\n      to right bottom,\n      rgba(45, 123, 113, 0.8),\n      rgba(33, 117, 115, 0.9)\n    ),\n    url(https://bscottnz.github.io/todo/img/wood-bg.jpg);\n}\n#content {\n  flex: 1;\n  padding: 5% 10%;\n  height: auto;\n  display: grid;\n  grid-template-rows: 2fr 14fr 1fr;\n  grid-template-columns: 1.5fr 7fr;\n}\n\n.header {\n  padding: 5px 20px;\n  grid-area: 1 / 1 / 2 / 3;\n  background-color: rgb(88, 23, 23);\n  font-size: 50px;\n  color: white;\n  display: flex;\n  align-items: center;\n}\n\n.sidebar {\n  grid-area: 2 / 1 / 3 / 2;\n  display: flex;\n  flex-direction: column;\n  background-color: rgb(28, 29, 30);\n  border-right: 1px black solid;\n  padding: 20px;\n  color: white;\n}\n.sidebar > button,\n.projects > button,\n.notes > button {\n  background-color: rgb(121, 38, 38);\n  color: white;\n  font-size: 20px;\n}\n.sidebar > button,\n.projects > button,\n.notes > button:hover {\n  cursor: pointer;\n}\n.projects,\n.notes {\n  font-size: 25px;\n}\n.addNewBtn {\n  margin-top: auto;\n  align-self: flex-start;\n  width: 60px;\n  height: 60px;\n  border-radius: 50%;\n  background-color: brown;\n  color: white;\n  font-size: 40px;\n}\n.main {\n  grid-area: 2 / 2 / 3 / 3;\n  padding-top: 30px;\n  padding-bottom: 30px;\n  background-color: rgb(208, 205, 201);\n  border-color: rgb(28, 29, 30);\n}\n.main-content {\n  background-color: rgb(28, 29, 30);\n  height: 100%;\n  padding-left: 40px;\n  padding-right: 40px;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n.footer {\n  grid-area: 3 / 1 / 4 / 3;\n}\n.projects {\n  display: flex;\n  flex-direction: column;\n}\n.query-form {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n  z-index: 9999;\n}\n.form-header {\n  grid-area: 1/1/2/3;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.form-sidebar {\n  grid-area: 2/1/4/2;\n  display: flex;\n  flex-direction: column;\n  gap: 1px;\n}\n.form-main {\n  grid-area: 2/2/3/3;\n  display: flex;\n  flex-direction: column;\n}\n.form-footer {\n  grid-area: 3/2/4/3;\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n}\n.radio-buttons {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  gap: 5px;\n}\n.formContent {\n  width: 600px;\n  height: 400px;\n  display: grid;\n  grid-template-rows: 40px 250px 100px;\n  grid-template-columns: 120px 1fr;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  background-color: white;\n  padding: 20px;\n  border-radius: 5px;\n}\n.form-sidebar > button {\n  border: none;\n  padding: 8px 15px 8px 15px;\n  background: rgb(88, 23, 23);\n  color: #fff;\n  box-shadow: 1px 1px 4px #dadada;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n}\n#close-formBtn {\n  border: none;\n  padding: 8px 15px 8px 15px;\n  background: rgb(88, 23, 23);\n  color: #fff;\n  box-shadow: 1px 1px 4px #dadada;\n  border-radius: 10px;\n}\n.submit-form {\n  justify-self: center;\n}\n#close-formBtn:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\n.form-sidebar > button:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\ninput[type=\"submit\"] {\n  border: none;\n  background: rgb(88, 23, 23);\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n}\ninput[type=\"submit\"]:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\ninput[type=\"button\"] {\n  box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  border: 1px solid #c2c2c2;\n  box-shadow: 1px 1px 4px #ebebeb;\n  -moz-box-shadow: 1px 1px 4px #ebebeb;\n  -webkit-box-shadow: 1px 1px 4px #ebebeb;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  padding: 7px;\n  outline: none;\n}\ninput[type=\"checkbox\"] {\n  box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  border: 1px solid #c2c2c2;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  padding: 7px;\n  outline: none;\n}\ninput:focus {\n  border: 1px solid rgb(129, 39, 39);\n}\n\n.priority-label-low,\n.priority-label-medium,\n.priority-label-high {\n  border: none;\n  padding: 5px 0;\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n  text-align: center;\n}\n.priority-label-low-selected,\n.priority-label-medium-selected,\n.priority-label-high-selected {\n  border: none;\n  padding: 5px 0;\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n  text-align: center;\n}\n.priority-label-low {\n  background-color: rgb(14, 94, 14);\n}\n.priority-label-low-selected {\n  background-color: rgb(111, 185, 111);\n}\n.priority-label-low:hover {\n  background-color: rgb(107, 184, 107);\n  cursor: pointer;\n}\n.priority-label-medium {\n  background-color: rgb(216, 150, 26);\n}\n.priority-label-medium-selected {\n  background-color: rgb(192, 163, 33);\n}\n.priority-label-medium:hover {\n  background-color: rgb(192, 163, 33);\n  cursor: pointer;\n}\n.priority-label-high {\n  background-color: rgb(190, 28, 28);\n}\n.priority-label-high-selected {\n  background-color: rgb(197, 74, 74);\n}\n.priority-label-high:hover {\n  background-color: rgb(190, 73, 73);\n  cursor: pointer;\n}\n.prio-high {\n  border-left: 3px rgb(190, 28, 28) solid;\n}\n.prio-medium {\n  border-left: 3px rgb(216, 150, 26) solid;\n}\n.prio-low {\n  border-left: 3px rgb(14, 94, 14) solid;\n}\ninput[type=\"radio\"] {\n  position: relative;\n  left: 2.2rem;\n  height: 1px;\n  width: 1px;\n  padding: 0;\n  margin: 0;\n  opacity: 0;\n  box-sizing: inherit;\n}\n.main-content-line {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 6px;\n  color: white;\n  background-color: rgb(32, 34, 36);\n}\n.main-content-line:hover {\n  box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n  transform: scale(1.004);\n}\n.fade {\n  text-decoration: line-through;\n  color: rgba(255, 255, 255, 0.3);\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n}\n.fadeBtn {\n  background-color: rgba(255, 255, 255, 0.3);\n}\n.details-button {\n  position: relative;\n  margin-right: 1rem;\n  padding: 0.5rem 1rem;\n  border: 1.5px solid #38ceba;\n  border-radius: 3px;\n  font-size: 12px;\n  color: #3ba395;\n  text-transform: uppercase;\n  font-weight: 700;\n  cursor: pointer;\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n  background-color: inherit;\n}\n.details-button:hover {\n  border-color: rgba(47, 131, 120, 0.5);\n  color: rgba(98, 190, 178, 0.5);\n  background-color: rgb(39, 141, 127);\n  cursor: pointer;\n}\n.fadeBtn {\n  opacity: 0.3;\n  background-color: inherit;\n}\n.contentBtn {\n  all: unset;\n  padding: 5px;\n  background-color: rgb(32, 34, 36);\n}\n.fa-trash-can,\n.fa-pen-to-square {\n  transition: all 0.3s;\n  color: crimson;\n}\n.fa-trash-can:hover,\n.fa-pen-to-square:hover {\n  cursor: pointer;\n  color: #3ba395;\n}\n.main-content-line-div {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.main-content-line-div > button > .icon {\n  width: 15px;\n  height: 15px;\n}\n.line-date {\n  min-width: 75px;\n}\n.details-display {\n  width: 300px;\n  height: 200px;\n  display: grid;\n  grid-template-rows: 100px 200px;\n  grid-template-columns: 1fr;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  background-color: #fff;\n  padding: 30px;\n  border-radius: 5px;\n}\n.details-container {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n  z-index: 9999;\n}\n.details-header {\n  grid-area: 1/1/2/1;\n  display: flex;\n  justify-content: space-between;\n}\n.details-body {\n  grid-area: 2/1/2/1;\n  display: flex;\n  flex-direction: column;\n}\n.details-exitBtn {\n  width: 40px;\n  height: 40px;\n}\n.details-title {\n  font-size: 60px;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;EAEE,YAAY;EACZ,SAAS;EACT,UAAU;AACZ;AACA;EACE,yCAAyC;AAC3C;AACA;EACE,aAAa;EACb;;;;;wDAKsD;AACxD;AACA;EACE,OAAO;EACP,eAAe;EACf,YAAY;EACZ,aAAa;EACb,gCAAgC;EAChC,gCAAgC;AAClC;;AAEA;EACE,iBAAiB;EACjB,wBAAwB;EACxB,iCAAiC;EACjC,eAAe;EACf,YAAY;EACZ,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,wBAAwB;EACxB,aAAa;EACb,sBAAsB;EACtB,iCAAiC;EACjC,6BAA6B;EAC7B,aAAa;EACb,YAAY;AACd;AACA;;;EAGE,kCAAkC;EAClC,YAAY;EACZ,eAAe;AACjB;AACA;;;EAGE,eAAe;AACjB;AACA;;EAEE,eAAe;AACjB;AACA;EACE,gBAAgB;EAChB,sBAAsB;EACtB,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,uBAAuB;EACvB,YAAY;EACZ,eAAe;AACjB;AACA;EACE,wBAAwB;EACxB,iBAAiB;EACjB,oBAAoB;EACpB,oCAAoC;EACpC,6BAA6B;AAC/B;AACA;EACE,iCAAiC;EACjC,YAAY;EACZ,kBAAkB;EAClB,mBAAmB;EACnB,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;AACA;EACE,wBAAwB;AAC1B;AACA;EACE,aAAa;EACb,sBAAsB;AACxB;AACA;EACE,aAAa;EACb,eAAe;EACf,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,oCAAoC,EAAE,gCAAgC;EACtE,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;AACrB;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,QAAQ;AACV;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,sBAAsB;AACxB;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,2BAA2B;AAC7B;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,WAAW;EACX,QAAQ;AACV;AACA;EACE,YAAY;EACZ,aAAa;EACb,aAAa;EACb,oCAAoC;EACpC,gCAAgC;EAChC,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,uBAAuB;EACvB,aAAa;EACb,kBAAkB;AACpB;AACA;EACE,YAAY;EACZ,0BAA0B;EAC1B,2BAA2B;EAC3B,WAAW;EACX,+BAA+B;EAC/B,oCAAoC;EACpC,uCAAuC;EACvC,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;AACd;AACA;EACE,YAAY;EACZ,0BAA0B;EAC1B,2BAA2B;EAC3B,WAAW;EACX,+BAA+B;EAC/B,mBAAmB;AACrB;AACA;EACE,oBAAoB;AACtB;AACA;EACE,eAAe;EACf,4BAA4B;EAC5B,WAAW;AACb;AACA;EACE,eAAe;EACf,4BAA4B;EAC5B,WAAW;AACb;AACA;EACE,YAAY;EACZ,2BAA2B;EAC3B,+BAA+B;EAC/B,YAAY;EACZ,oCAAoC;EACpC,uCAAuC;EACvC,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;AACd;AACA;EACE,eAAe;EACf,4BAA4B;EAC5B,WAAW;AACb;AACA;EACE,sBAAsB;EACtB,8BAA8B;EAC9B,2BAA2B;EAC3B,yBAAyB;EACzB,+BAA+B;EAC/B,oCAAoC;EACpC,uCAAuC;EACvC,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;EACZ,aAAa;AACf;AACA;EACE,sBAAsB;EACtB,8BAA8B;EAC9B,2BAA2B;EAC3B,yBAAyB;EACzB,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;EACZ,aAAa;AACf;AACA;EACE,kCAAkC;AACpC;;AAEA;;;EAGE,YAAY;EACZ,cAAc;EACd,+BAA+B;EAC/B,YAAY;EACZ,oCAAoC;EACpC,uCAAuC;EACvC,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;EACZ,kBAAkB;AACpB;AACA;;;EAGE,YAAY;EACZ,cAAc;EACd,+BAA+B;EAC/B,YAAY;EACZ,oCAAoC;EACpC,uCAAuC;EACvC,kBAAkB;EAClB,0BAA0B;EAC1B,uBAAuB;EACvB,YAAY;EACZ,kBAAkB;AACpB;AACA;EACE,iCAAiC;AACnC;AACA;EACE,oCAAoC;AACtC;AACA;EACE,oCAAoC;EACpC,eAAe;AACjB;AACA;EACE,mCAAmC;AACrC;AACA;EACE,mCAAmC;AACrC;AACA;EACE,mCAAmC;EACnC,eAAe;AACjB;AACA;EACE,kCAAkC;AACpC;AACA;EACE,kCAAkC;AACpC;AACA;EACE,kCAAkC;EAClC,eAAe;AACjB;AACA;EACE,uCAAuC;AACzC;AACA;EACE,wCAAwC;AAC1C;AACA;EACE,sCAAsC;AACxC;AACA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,UAAU;EACV,UAAU;EACV,SAAS;EACT,UAAU;EACV,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,iCAAiC;AACnC;AACA;EACE,2CAA2C;EAC3C,uBAAuB;AACzB;AACA;EACE,6BAA6B;EAC7B,+BAA+B;EAC/B,4BAA4B;EAC5B,oBAAoB;AACtB;AACA;EACE,0CAA0C;AAC5C;AACA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,oBAAoB;EACpB,2BAA2B;EAC3B,kBAAkB;EAClB,eAAe;EACf,cAAc;EACd,yBAAyB;EACzB,gBAAgB;EAChB,eAAe;EACf,4BAA4B;EAC5B,oBAAoB;EACpB,yBAAyB;AAC3B;AACA;EACE,qCAAqC;EACrC,8BAA8B;EAC9B,mCAAmC;EACnC,eAAe;AACjB;AACA;EACE,YAAY;EACZ,yBAAyB;AAC3B;AACA;EACE,UAAU;EACV,YAAY;EACZ,iCAAiC;AACnC;AACA;;EAEE,oBAAoB;EACpB,cAAc;AAChB;AACA;;EAEE,eAAe;EACf,cAAc;AAChB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;AACX;AACA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,eAAe;AACjB;AACA;EACE,YAAY;EACZ,aAAa;EACb,aAAa;EACb,+BAA+B;EAC/B,0BAA0B;EAC1B,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,sBAAsB;EACtB,aAAa;EACb,kBAAkB;AACpB;AACA;EACE,aAAa;EACb,eAAe;EACf,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,oCAAoC,EAAE,gCAAgC;EACtE,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,8BAA8B;AAChC;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,sBAAsB;AACxB;AACA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,eAAe;AACjB","sourcesContent":["html,\nbody {\n  height: 100%;\n  margin: 0;\n  padding: 0;\n}\n* {\n  font-family: Arial, Helvetica, sans-serif;\n}\nbody {\n  display: flex;\n  background: linear-gradient(\n      to right bottom,\n      rgba(45, 123, 113, 0.8),\n      rgba(33, 117, 115, 0.9)\n    ),\n    url(https://bscottnz.github.io/todo/img/wood-bg.jpg);\n}\n#content {\n  flex: 1;\n  padding: 5% 10%;\n  height: auto;\n  display: grid;\n  grid-template-rows: 2fr 14fr 1fr;\n  grid-template-columns: 1.5fr 7fr;\n}\n\n.header {\n  padding: 5px 20px;\n  grid-area: 1 / 1 / 2 / 3;\n  background-color: rgb(88, 23, 23);\n  font-size: 50px;\n  color: white;\n  display: flex;\n  align-items: center;\n}\n\n.sidebar {\n  grid-area: 2 / 1 / 3 / 2;\n  display: flex;\n  flex-direction: column;\n  background-color: rgb(28, 29, 30);\n  border-right: 1px black solid;\n  padding: 20px;\n  color: white;\n}\n.sidebar > button,\n.projects > button,\n.notes > button {\n  background-color: rgb(121, 38, 38);\n  color: white;\n  font-size: 20px;\n}\n.sidebar > button,\n.projects > button,\n.notes > button:hover {\n  cursor: pointer;\n}\n.projects,\n.notes {\n  font-size: 25px;\n}\n.addNewBtn {\n  margin-top: auto;\n  align-self: flex-start;\n  width: 60px;\n  height: 60px;\n  border-radius: 50%;\n  background-color: brown;\n  color: white;\n  font-size: 40px;\n}\n.main {\n  grid-area: 2 / 2 / 3 / 3;\n  padding-top: 30px;\n  padding-bottom: 30px;\n  background-color: rgb(208, 205, 201);\n  border-color: rgb(28, 29, 30);\n}\n.main-content {\n  background-color: rgb(28, 29, 30);\n  height: 100%;\n  padding-left: 40px;\n  padding-right: 40px;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n.footer {\n  grid-area: 3 / 1 / 4 / 3;\n}\n.projects {\n  display: flex;\n  flex-direction: column;\n}\n.query-form {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n  z-index: 9999;\n}\n.form-header {\n  grid-area: 1/1/2/3;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.form-sidebar {\n  grid-area: 2/1/4/2;\n  display: flex;\n  flex-direction: column;\n  gap: 1px;\n}\n.form-main {\n  grid-area: 2/2/3/3;\n  display: flex;\n  flex-direction: column;\n}\n.form-footer {\n  grid-area: 3/2/4/3;\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n}\n.radio-buttons {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  gap: 5px;\n}\n.formContent {\n  width: 600px;\n  height: 400px;\n  display: grid;\n  grid-template-rows: 40px 250px 100px;\n  grid-template-columns: 120px 1fr;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  background-color: white;\n  padding: 20px;\n  border-radius: 5px;\n}\n.form-sidebar > button {\n  border: none;\n  padding: 8px 15px 8px 15px;\n  background: rgb(88, 23, 23);\n  color: #fff;\n  box-shadow: 1px 1px 4px #dadada;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n}\n#close-formBtn {\n  border: none;\n  padding: 8px 15px 8px 15px;\n  background: rgb(88, 23, 23);\n  color: #fff;\n  box-shadow: 1px 1px 4px #dadada;\n  border-radius: 10px;\n}\n.submit-form {\n  justify-self: center;\n}\n#close-formBtn:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\n.form-sidebar > button:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\ninput[type=\"submit\"] {\n  border: none;\n  background: rgb(88, 23, 23);\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n}\ninput[type=\"submit\"]:hover {\n  cursor: pointer;\n  background: rgb(129, 39, 39);\n  color: #fff;\n}\ninput[type=\"button\"] {\n  box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  border: 1px solid #c2c2c2;\n  box-shadow: 1px 1px 4px #ebebeb;\n  -moz-box-shadow: 1px 1px 4px #ebebeb;\n  -webkit-box-shadow: 1px 1px 4px #ebebeb;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  padding: 7px;\n  outline: none;\n}\ninput[type=\"checkbox\"] {\n  box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  border: 1px solid #c2c2c2;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  padding: 7px;\n  outline: none;\n}\ninput:focus {\n  border: 1px solid rgb(129, 39, 39);\n}\n\n.priority-label-low,\n.priority-label-medium,\n.priority-label-high {\n  border: none;\n  padding: 5px 0;\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n  text-align: center;\n}\n.priority-label-low-selected,\n.priority-label-medium-selected,\n.priority-label-high-selected {\n  border: none;\n  padding: 5px 0;\n  box-shadow: 1px 1px 4px #dadada;\n  color: white;\n  -moz-box-shadow: 1px 1px 4px #dadada;\n  -webkit-box-shadow: 1px 1px 4px #dadada;\n  border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  width: 100px;\n  text-align: center;\n}\n.priority-label-low {\n  background-color: rgb(14, 94, 14);\n}\n.priority-label-low-selected {\n  background-color: rgb(111, 185, 111);\n}\n.priority-label-low:hover {\n  background-color: rgb(107, 184, 107);\n  cursor: pointer;\n}\n.priority-label-medium {\n  background-color: rgb(216, 150, 26);\n}\n.priority-label-medium-selected {\n  background-color: rgb(192, 163, 33);\n}\n.priority-label-medium:hover {\n  background-color: rgb(192, 163, 33);\n  cursor: pointer;\n}\n.priority-label-high {\n  background-color: rgb(190, 28, 28);\n}\n.priority-label-high-selected {\n  background-color: rgb(197, 74, 74);\n}\n.priority-label-high:hover {\n  background-color: rgb(190, 73, 73);\n  cursor: pointer;\n}\n.prio-high {\n  border-left: 3px rgb(190, 28, 28) solid;\n}\n.prio-medium {\n  border-left: 3px rgb(216, 150, 26) solid;\n}\n.prio-low {\n  border-left: 3px rgb(14, 94, 14) solid;\n}\ninput[type=\"radio\"] {\n  position: relative;\n  left: 2.2rem;\n  height: 1px;\n  width: 1px;\n  padding: 0;\n  margin: 0;\n  opacity: 0;\n  box-sizing: inherit;\n}\n.main-content-line {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 6px;\n  color: white;\n  background-color: rgb(32, 34, 36);\n}\n.main-content-line:hover {\n  box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);\n  transform: scale(1.004);\n}\n.fade {\n  text-decoration: line-through;\n  color: rgba(255, 255, 255, 0.3);\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n}\n.fadeBtn {\n  background-color: rgba(255, 255, 255, 0.3);\n}\n.details-button {\n  position: relative;\n  margin-right: 1rem;\n  padding: 0.5rem 1rem;\n  border: 1.5px solid #38ceba;\n  border-radius: 3px;\n  font-size: 12px;\n  color: #3ba395;\n  text-transform: uppercase;\n  font-weight: 700;\n  cursor: pointer;\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n  background-color: inherit;\n}\n.details-button:hover {\n  border-color: rgba(47, 131, 120, 0.5);\n  color: rgba(98, 190, 178, 0.5);\n  background-color: rgb(39, 141, 127);\n  cursor: pointer;\n}\n.fadeBtn {\n  opacity: 0.3;\n  background-color: inherit;\n}\n.contentBtn {\n  all: unset;\n  padding: 5px;\n  background-color: rgb(32, 34, 36);\n}\n.fa-trash-can,\n.fa-pen-to-square {\n  transition: all 0.3s;\n  color: crimson;\n}\n.fa-trash-can:hover,\n.fa-pen-to-square:hover {\n  cursor: pointer;\n  color: #3ba395;\n}\n.main-content-line-div {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.main-content-line-div > button > .icon {\n  width: 15px;\n  height: 15px;\n}\n.line-date {\n  min-width: 75px;\n}\n.details-display {\n  width: 300px;\n  height: 200px;\n  display: grid;\n  grid-template-rows: 100px 200px;\n  grid-template-columns: 1fr;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  background-color: #fff;\n  padding: 30px;\n  border-radius: 5px;\n}\n.details-container {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n  z-index: 9999;\n}\n.details-header {\n  grid-area: 1/1/2/1;\n  display: flex;\n  justify-content: space-between;\n}\n.details-body {\n  grid-area: 2/1/2/1;\n  display: flex;\n  flex-direction: column;\n}\n.details-exitBtn {\n  width: 40px;\n  height: 40px;\n}\n.details-title {\n  font-size: 60px;\n}\n"],"sourceRoot":""}]);
// Exports
...
(0,_DOM__WEBPACK_IMPORTED_MODULE_2__.loadProjects)();
...
homeTasksBtn.addEventListener("click", function () {
  _DOM__WEBPACK_IMPORTED_MODULE_2__.taskManager.drawAllTasks(
    _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[0].tasks,
    _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[0].id
  );
...
studyTasksBtn.addEventListener("click", function () {
  _DOM__WEBPACK_IMPORTED_MODULE_2__.taskManager.drawAllTasks(
    _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[3].tasks,
    _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[3].id
  );
  for (let i = 0; i < _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects.length; i++)
    if (_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].isActive === 1)
      _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].isActive = 0;
  _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[3].isActive = 1;
});
...
todayTasksBtn.addEventListener("click", function () {
  ...
  for (let i = 0; i < _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects.length; i++) {
    if (
      _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].id !== "today" &&
      ...
      for (let c = 0; c < _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks.length; c++)
        if (
          (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(
            (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todayDate),
            (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(_factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks[c].dateDue)
          ) === 0
        ) {
          (0,_DOM__WEBPACK_IMPORTED_MODULE_2__.drawTask)(
            _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].tasks[c],
            _factory__WEBPACK_IMPORTED_MODULE_1__.projectsManager.projects[i].id
          );
        }
    }
  }
