...
import DOMtoDo, {addNewQuery,defaultToDo, changeNote, changeProject,changeToDo, drawTask, loadProjects,
...
homeTasksBtn.addEventListener('click', function(){
    taskManager.drawAllTasks(projectsManager.projects[0].tasks, projectsManager.projects[0].id)
...
studyTasksBtn.addEventListener('click', function(){
    taskManager.drawAllTasks(projectsManager.projects[3].tasks, projectsManager.projects[3].id)
    for(let i=0; i<projectsManager.projects.length; i++)
       if(projectsManager.projects[i].isActive === 1)
       projectsManager.projects[i].isActive = 0
